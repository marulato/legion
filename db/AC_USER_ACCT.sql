...
BEGIN
    INSERT INTO AC_USER_ACCT_H(AUDIT_ID, AUDIT_TYPE, AUDIT_TIME,
                               USER_ID, DOMAIN, NAME, DISPLAY_NAME, TYPE, PASSWORD,
    ...
    VALUES (NULL, 'AI', NOW(),
            NEW.USER_ID, NEW.DOMAIN, NEW.NAME, NEW.DISPLAY_NAME, NEW.TYPE, NEW.PASSWORD,
...
BEGIN
    INSERT INTO AC_USER_ACCT_H(AUDIT_ID, AUDIT_TYPE, AUDIT_TIME,
                               ...
                               DEACTIVATED_AT, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY)
    VALUES (NULL, 'BU', NOW(),
            OLD.USER_ID, OLD.DOMAIN, OLD.NAME, OLD.DISPLAY_NAME, OLD.TYPE, OLD.PASSWORD,
